//
//  MedicalInfomationViewController.m
//  Medical
//
...
#import "MedicalInfomationViewController.h"
#import "MedicalActiveViewController.h"

@interface MedicalInfomationViewController ()

@end

@implementation MedicalInfomationViewController
...
- (void)loadData
{
    [[AFAPPRequestManager manager]GET:@"api/article-list" parameters:@{@"type":@"20",@"page":@(self.curPage),@"pageNum":@"10"} success:^(NSURLSessionDataTask *task, id responseObject) {
